...
public class CommentsCollectorController {
    ...
    public ResponseEntity<Map<String, Object>> collectComments(@RequestBody Map<String, Object> body) {
        ...
        Object maxCommentsObj = body.get("maxComments");
        int maxComments = maxCommentsObj != null ? Integer.parseInt(maxCommentsObj.toString()) : 200;
        ...
        try {
            List<Map<String, Object>> comments = commentsCollectorService.retrieveComments(urls, keyword, search, maxComments);
