...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Search}.
 */
@RestController
...
public class SearchResource {
    ...
    public ResponseEntity<SearchDTO> createSearch(@RequestBody SearchDTO searchDTO) throws URISyntaxException {
        ...
        searchDTO = searchService.save(searchDTO);
        return ResponseEntity.created(new URI("/api/searches/" + searchDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, searchDTO.getId().toString()))
            .body(searchDTO);
    }
    ...
    public ResponseEntity<SearchDTO> updateSearch(
        ...
        searchDTO = searchService.update(searchDTO);
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, searchDTO.getId().toString()))
            .body(searchDTO);
    }
    ...
    public ResponseEntity<SearchDTO> partialUpdateSearch(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, searchDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<SearchDTO> getSearch(@PathVariable("id") Long id) {
