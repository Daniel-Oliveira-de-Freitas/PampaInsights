...
class CommentResourceIT {
    ...
    private static final Long DEFAULT_SENTIMENT = 1L;
    private static final Long UPDATED_SENTIMENT = 2L;
    ...
    public static Comment createEntity() {
        return new Comment().body(DEFAULT_BODY).sentiment(DEFAULT_SENTIMENT).author(DEFAULT_AUTHOR).createDate(DEFAULT_CREATE_DATE);
    }
    ...
    public static Comment createUpdatedEntity() {
        return new Comment().body(UPDATED_BODY).sentiment(UPDATED_SENTIMENT).author(UPDATED_AUTHOR).createDate(UPDATED_CREATE_DATE);
    }
    ...
    void getAllComments() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.[*].sentiment").value(hasItem(DEFAULT_SENTIMENT.intValue())))
    ...
    void getComment() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.sentiment").value(DEFAULT_SENTIMENT.intValue()))
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.body(UPDATED_BODY).sentiment(UPDATED_SENTIMENT).author(UPDATED_AUTHOR).createDate(UPDATED_CREATE_DATE);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.sentiment(UPDATED_SENTIMENT).author(UPDATED_AUTHOR);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.body(UPDATED_BODY).sentiment(UPDATED_SENTIMENT).author(UPDATED_AUTHOR).createDate(UPDATED_CREATE_DATE);
